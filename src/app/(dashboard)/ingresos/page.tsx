      ...
      <div className="gap-6 flex flex-col w-full">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Total de ingresos registrados hasta la fecha</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold">${getTotalIncomes().toFixed(2)}</div>
          </CardContent>
        </Card>
          ...
          <TabsContent value="registro">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Ingresa los detalles de la venta o ingreso</CardDescription>
              </CardHeader>
              <CardContent>
                <IncomeForm />
              </CardContent>
