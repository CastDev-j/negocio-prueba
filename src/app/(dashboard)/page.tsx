...
import { BarChart3, CreditCard, DollarSign, LineChart, ShoppingCart } from "lucide-react"

export default function Home() {
  return (
    <div className="container mx-auto py-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight">Gestión Financiera para Pequeños Negocios</h1>
        <p className="text-muted-foreground mt-2">Controla tus finanzas de manera sencilla y efectiva</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Visualiza tus ingresos, costos, gastos y ganancias en un solo lugar.
            </p>
          </CardContent>
        </Card>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Pasos para registrar ingresos, costos y gastos</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Entendiendo los informes financieros</CardDescription>
            </CardHeader>
            <CardContent>
              <ul className="list-disc list-inside space-y-2">
                <li>
                  <strong>Estado de Resultados:</strong> Muestra si tu negocio está generando ganancias o pérdidas.
                </li>
                <li>
                  <strong>Flujo de Caja:</strong> Indica la disponibilidad de efectivo en diferentes momentos.
                </li>
                <li>
                  <strong>Exportación de datos:</strong> Permite descargar la información para análisis externos.
                </li>
              </ul>
            </CardContent>
          </Card>
