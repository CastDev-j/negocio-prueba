...
export default function ProfitLossPage() {
  const { getTotalIncomes, getTotalCosts, getTotalExpenses, getProfit } =
    useFinanceStore();
      ...
      <div className="mt-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Desglose de ingresos, costos y gastos
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-xl font-bold">
                        {totalIncomes > 0
                          ? `${(
                              ((totalIncomes - totalCosts) / totalIncomes) *
                              100
                            ).toFixed(2)}%`
                          : "N/A"}
                      </div>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-xl font-bold">
                        {totalIncomes > 0
                          ? `${((profit / totalIncomes) * 100).toFixed(2)}%`
                          : "N/A"}
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-xl font-bold">
                        {totalIncomes > 0
                          ? `${((totalCosts / totalIncomes) * 100).toFixed(2)}%`
                          : "N/A"}
                      </div>
                    </CardContent>
                  </Card>
